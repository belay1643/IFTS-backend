    ...
    >
      ...
      <div className="relative w-full max-w-lg bg-[rgba(255,255,255,0.08)] backdrop-blur-[22px] border border-[rgba(255,255,255,0.18)] rounded-[16px] shadow-[0_22px_60px_rgba(0,0,0,0.38)] px-7 py-8 space-y-5 text-white transition hover:-translate-y-[2px] animate-fade-scale">
        <div className="flex justify-start">
          <Link to="/" className="flex items-center gap-4 text-white/90 hover:text-white font-semibold">
        ...
        <div className="text-center space-y-1.5">
          <div className="text-[22px] font-bold">Ethio Vest</div>
          <p className="text-[13px] text-white/80">Create your account</p>
          <p className="text-[12px] text-white/70">Start managing your investments with confidence.</p>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-3.5">
          ...
          {success && <p className="text-base text-emerald-200 bg-emerald-900/30 border border-emerald-500/30 rounded px-3 py-3">{success}</p>}

          <button
            type="submit"
            className="w-full py-3 rounded-[10px] text-base font-semibold text-white shadow-[0_10px_24px_rgba(34,197,94,0.3)] transition hover:-translate-y-[2px]"
